...
static void zynq_init(MachineState *machine)
{
    ...
    qdev_prop_set_uint32(dev, "num-cpu", 2); /* Force 2 cores for the OpenSSD */
    qdev_init_nofail(dev);
...
*/       
    ...
    zynq_binfo.nb_cpus = 2; /* Force 2 CPUs */
...
static void zynq_machine_init(MachineClass *mc)
{
    ...
    mc->init = zynq_init;
    //mc->max_cpus = 1;
    mc->max_cpus = 2; /* Force 2 CPUs */
    mc->no_sdcard = 1;
    mc->has_dynamic_sysbus = true; /* To dynamic attach devices on the platform */
}
